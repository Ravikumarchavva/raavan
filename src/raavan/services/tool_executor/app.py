...
Entry point: uvicorn raavan.services.tool_executor.app:app --port 8015
"""
...
from raavan.services.tool_executor.executor import ToolRegistry
from raavan.services.tool_executor.routes import router
...
def _load_default_tools(ci_http_client=None) -> list:
    ...
    if ci_http_client is not None:
        try:
            from raavan.catalog.tools.code_interpreter.tool import (
                CodeInterpreterTool,
            )
