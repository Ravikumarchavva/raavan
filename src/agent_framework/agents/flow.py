...
from agent_framework.agents.agent_result import AgentRunResult, AggregatedUsage, RunStatus
from agent_framework.agents.base_agent import BaseAgent
from agent_framework.agents.graph import FlowEdge, FlowGraph, FlowNode
    ...
    async def run_stream(self, input_text: str, **kwargs) -> AsyncIterator[Any]:
        ...
        for step in self.steps:
            ...
            async for chunk in stream:
                ...
                from agent_framework.messages._types import TextDeltaChunk
