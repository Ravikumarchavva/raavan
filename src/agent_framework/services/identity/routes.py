...
from agent_framework.shared.auth.middleware import get_current_user
from agent_framework.shared.auth import jwt as jwt_utils
from agent_framework.shared.contracts.auth import (
    AgentTokenRequest,
    AgentTokenResponse,
    RefreshRequest,
...
async def exchange_token(body: TokenExchangeRequest, request: Request):
    ...
    from agent_framework.services.identity.service import exchange_frontend_token
